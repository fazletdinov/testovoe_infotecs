...
Проект релизован с помощью Fastapi, SQLAlchemy, SQLite
...
```
### В директории `database` есть скрипт `filling_in_the_database.py` ### для автоматического заполнения вашей базы данных, данными из 
...
### Пример запроса
`GET api/v1/cities/?page=3&size=3`
